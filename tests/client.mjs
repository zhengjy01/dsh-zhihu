...
check('声明了插件 id', code.includes('"@zhengjy01/dsh-zhihu"') || code.includes("'@zhengjy01/dsh-zhihu'"))
...
check('bundle id 等于包名', runA.recorded.loaded?.id === '@zhengjy01/dsh-zhihu', String(runA.recorded.loaded?.id))
